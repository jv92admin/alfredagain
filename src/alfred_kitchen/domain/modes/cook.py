...
from alfred_kitchen.background.profile_builder import format_profile_for_prompt, get_cached_profile
...
_PROMPT_PATH = Path(__file__).parent.parent / "prompts" / "cook.md"
