"""
Kitchen test fixtures — KITCHEN_DOMAIN registered, Supabase mocks available.

These fixtures enable testing alfred_kitchen features that depend on
the kitchen domain configuration and its entities.
"""
...
# Import alfred_kitchen triggers KITCHEN_DOMAIN registration
...
def ensure_kitchen_domain():
    """Ensure KITCHEN_DOMAIN is registered for every kitchen test."""
